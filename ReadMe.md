...
When you are using <Route> by itself outside of a <Switch>, you can use useRouteMatch to access its match data.

2. How would you explain form validation to someone who has never programmed before?

It's what you would use to make sure the user filled out all the information correctly with all the fields that you need.

3. In 1-2 sentences, define end to end testing.

Its used to test the flow of an application like you designed it from start to finish.
